...
try:
    ...
    from api.audio_generator import generate_audio_file_async, get_voice_id, get_cache_dir
except ImportError:
    from agent_helper import generate_script_with_agent, chat_with_agent
    from audio_generator import generate_audio_file_async, get_voice_id, get_cache_dir
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        print(f"! [DB Error] Lỗi khởi tạo SQLite: {e}")
    yield
